      ...
      <div>
        <Router history={history}>
          <Switch>
            ...
            <Route path="/employserach" component={EmployeeSearchpage} />
            <Route path="/notification" component={Notifationpage} />

            <Route path="/jobapply/:id" component={JobsApplypage} />
            <Route path="/resumeattch/:id" component={Resumattached} />
            <Route path="/success" component={Successpage} />
            <Route path="/bookmarks" component={Booksmarks} />
            <Route path="/application" component={Applicationpage} />
            <Route path="/reviewapplication" component={Reviewapplications} />
            <Route path="/notsutableapplication" component={Notsutables} />
            <Route path="/interviewapplication" component={Interviews} />
            ...
            <Route path="/yourdetailsjobs" component={YourDetailspage} />
            <Route path="/yourapplication/:id" component={Yourapplications} />
